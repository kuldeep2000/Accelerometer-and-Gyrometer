// BT19CSE067 (KULDEEP SINGH PARMAR)
                      ...
                      Padding(
                          ...
                          child: Builder(builder: (context) {
                            if (_selectedSensor == 'gyroscope') {
                              return Container(
                                  child: Text(xG.toStringAsFixed(3),
                                      style: TextStyle(fontSize: 20.0)),
                                  width: 10.0,
                                  height: 20.0);
                            } else {
                              return Container(
                                  child: Text(xA.toStringAsFixed(3),
                                      style: TextStyle(fontSize: 20.0)),
                                  width: 10.0,
                                  height: 20.0);
                            }
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: Builder(builder: (context) {
                            if (_selectedSensor == 'gyroscope') {
                              return Container(
                                  child: Text(yG.toStringAsFixed(3),
                                      style: TextStyle(fontSize: 20.0)),
                                  width: 10.0,
                                  height: 20.0);
                            } else {
                              return Container(
                                  child: Text(yA.toStringAsFixed(3),
                                      style: TextStyle(fontSize: 20.0)),
                                  width: 10.0,
                                  height: 20.0);
                            }
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: Builder(builder: (context) {
                            if (_selectedSensor == 'gyroscope') {
                              return Container(
                                  child: Text(zG.toStringAsFixed(3),
                                      style: TextStyle(fontSize: 20.0)),
                                  width: 10.0,
                                  height: 20.0);
                            } else {
                              return Container(
                                  child: Text(zA.toStringAsFixed(3),
                                      style: TextStyle(fontSize: 20.0)),
                                  width: 10.0,
                                  height: 20.0);
                            }
